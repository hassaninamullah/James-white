                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="row">
                              <div class="col-md-2">
                                <p><a href="Cumulativeedit.php">

                                    <i class="fa fa-edit" style="color:lightgreen" data-toggle="modal"
                                      data-target="#myModal"></i></a></p>
                              </div>
                              <div class="col-md-2">
                                  <p><a href="Cumulativeview.php"><i class="fa fa-eye" style="color:#0da8ee"></i></a></p>
                                </div>
                              <div class="col-md-2">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Annual Financial</h5>
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label>Daily Cumulative :</label>
            <input type="text" class="form-control">
          </div>
         
          <div class="form-group">
            <label>Monthly Cumulative :</label>
            <input type="text" class="form-control">
          </div>

          <div class="form-group">
            <label>Annual Cumulative :</label>
            <input type="text" class="form-control">
          </div>
